      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm space-y-7">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-[11px] text-gray-500 tracking-widest uppercase mb-1.5">Full Name</label>
            ...
            <div>
              <label className="block text-[11px] text-gray-500 tracking-widest uppercase mb-1.5">Password</label>
              <div className="relative">
            ...
            <div>
              <label className="block text-[11px] text-gray-500 tracking-widest uppercase mb-1.5">Confirm Password</label>
              <div className="relative">
                <Lock size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-600" />
                <input
              ...
              {passwordWrong && <p className="text-red-400 text-xs mt-1.5">Passwords do not match</p>}
              {passwordMatch && <p className="text-emerald-400 text-xs mt-1.5">Passwords match</p>}
            </div>
